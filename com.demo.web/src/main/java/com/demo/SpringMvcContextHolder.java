...
public abstract class SpringMvcContextHolder {
    ...
    /**
     * 获取当前RequestAttributes，该类有很多子类。如果想通过它获取request的话转型成{@link org.springframework.web.context.request.ServletRequestAttributes}.getRequest()即可
     *
     * @return {@link org.springframework.web.context.request.RequestAttributes}
     */
